...
class VariationalAutoencoder(object):
    ...
    def __init__(self, network_architecture, main_dir='vae', model_name = 'vae_model', transfer_fct=tf.nn.softplus, 
        ...
        # main directory to put models and checkpoint
        ...
        self.sess.run(init)
        self.tf_summary_writer = tf.train.SummaryWriter(self.summary_dir, self.sess.graph)
    ...
    def _create_data_directories(self):
        ...
        models_dir = models_dir + self.main_dir
        data_dir = data_dir + self.main_dir
        summary_dir = summary_dir + self.main_dir
    ...
    def save_model(self): 
    	self.tf_saver.save(self.sess, self.model_path)
